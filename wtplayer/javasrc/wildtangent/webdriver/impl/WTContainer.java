...
public class WTContainer extends wildtangent.webdriver.jni.WTContainer
    implements wildtangent.webdriver.WTContainer {

    public WTContainer(long cPtr, boolean cMemoryOwn) {
