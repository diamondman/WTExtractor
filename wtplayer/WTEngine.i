...
%ignore WTEVENT_RENDEREVENT;
%ignore WTEVENT_MOUSEEVENT;
%ignore WTEVENT_MOUSEMOVEEVENT;
%ignore WTEVENT_MOUSELEFTDBLCLICKEVENT;
%ignore WTEVENT_MOUSELEFTBUTTONDOWN;
%ignore WTEVENT_MOUSELEFTBUTTONUP;
%ignore WTEVENT_MOUSERIGHTDBLCLICKEVENT;
%ignore WTEVENT_MOUSERIGHTBUTTONDOWN;
%ignore WTEVENT_MOUSERIGHTBUTTONUP;
%ignore WTEVENT_MOUSEMIDDLEDBLCLICKEVENT;
%ignore WTEVENT_MOUSEMIDDLEBUTTONDOWN;
%ignore WTEVENT_MOUSEMIDDLEBUTTONUP;
%ignore WTEVENT_KEYBOARDEVENT;
%ignore WTEVENT_EXCEPTIONEVENT;
%ignore BTNSTATE_LEFT;
%ignore BTNSTATE_RIGHT;
%ignore BTNSTATE_SHIFT;
%ignore BTNSTATE_CTRL;
%ignore BTNSTATE_MIDDLE;
%ignore KEY_RELEASE;
%ignore KEY_PRESS;
