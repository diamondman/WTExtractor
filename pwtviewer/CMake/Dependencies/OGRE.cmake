...
macro( findPluginAndSetPath BUILD_TYPE CFG_VARIABLE LIBRARY_NAME )
	...
	if( EXISTS ${REAL_LIB_PATH} )
		...
		copyWithSymLink( ${REAL_LIB_PATH} "${PROJECT_SOURCE_DIR}/bin/${BUILD_TYPE}/Plugins" )
	endif()
endmacro()
...
macro( setupPluginFileFromTemplate BUILD_TYPE )
	if( NOT APPLE )
		...
		file( MAKE_DIRECTORY "${PROJECT_SOURCE_DIR}/bin/${BUILD_TYPE}/Plugins" )
	endif()
	...
	if( ${BUILD_TYPE} STREQUAL "Debug" )
	  #configure_file( ${CMAKE_SOURCE_DIR}/CMake/Templates/Plugins.cfg.in ${CMAKE_SOURCE_DIR}/bin/${BUILD_TYPE}/plugins_d.cfg )
          configure_file( ${PROJECT_SOURCE_DIR}/CMake/Templates/Plugins.cfg.in ${PROJECT_SOURCE_DIR}/bin/${BUILD_TYPE}/plugins_d.cfg )
	else()
	  #configure_file( ${CMAKE_SOURCE_DIR}/CMake/Templates/Plugins.cfg.in ${CMAKE_SOURCE_DIR}/bin/${BUILD_TYPE}/plugins.cfg )
          configure_file( ${PROJECT_SOURCE_DIR}/CMake/Templates/Plugins.cfg.in ${PROJECT_SOURCE_DIR}/bin/${BUILD_TYPE}/plugins.cfg )
	endif()
	...
	# Copy
	# "${OGRE_BINARIES}/bin/${BUILD_TYPE}/OgreMain.dll" to "${PROJECT_SOURCE_DIR}/bin/${BUILD_TYPE}
		...
		if( EXISTS "${OGRE_DLL_PATH}/${DLL_OS_PREFIX}${DLL_NAME}${DLL_OS_SUFFIX}" )
			foreach( DLL_NAME ${OGRE_DLLS} )
				copyWithSymLink( "${OGRE_DLL_PATH}/${DLL_OS_PREFIX}${DLL_NAME}${DLL_OS_SUFFIX}"
								 "${PROJECT_SOURCE_DIR}/bin/${BUILD_TYPE}" )
			endforeach()
		endif()
	endif()
...
function( setupResourceFileFromTemplate )
	message( STATUS "Generating ${PROJECT_SOURCE_DIR}/bin/Data/resources2.cfg from template
	...
	configure_file( ${PROJECT_SOURCE_DIR}/CMake/Templates/Resources.cfg.in ${PROJECT_SOURCE_DIR}/bin/Data/resources2.cfg )
endfunction()
...
function( setupOgreSamplesCommon )
	message( STATUS "Copying OgreSamplesCommon cpp and header files to
		${PROJECT_SOURCE_DIR}/include/OgreCommon
		${PROJECT_SOURCE_DIR}/src/OgreCommon/" )
	include_directories( "${PROJECT_SOURCE_DIR}/include/OgreCommon/" )
	file( COPY "${OGRE_SOURCE}/Samples/2.0/Common/include/"	DESTINATION "${PROJECT_SOURCE_DIR}/include/OgreCommon/" )
	file( COPY "${OGRE_SOURCE}/Samples/2.0/Common/src/"		DESTINATION "${PROJECT_SOURCE_DIR}/src/OgreCommon/" )
endfunction()
...
file( COPY "${OGRE_SOURCE}/Samples/Media/Hlms/Common"	DESTINATION "${PROJECT_SOURCE_DIR}/bin/Data/Hlms" )
file( COPY "${OGRE_SOURCE}/Samples/Media/Hlms/Pbs"		DESTINATION "${PROJECT_SOURCE_DIR}/bin/Data/Hlms" )
file( COPY "${OGRE_SOURCE}/Samples/Media/Hlms/Unlit"	DESTINATION "${PROJECT_SOURCE_DIR}/bin/Data/Hlms" )

message( STATUS "Copying Common data files from Ogre repository" )
file( COPY "${OGRE_SOURCE}/Samples/Media/2.0/scripts/materials/Common"	DESTINATION "${PROJECT_SOURCE_DIR}/bin/Data/Materials" )
file( COPY "${OGRE_SOURCE}/Samples/Media/packs/DebugPack.zip"	DESTINATION "${PROJECT_SOURCE_DIR}/bin/Data" )
